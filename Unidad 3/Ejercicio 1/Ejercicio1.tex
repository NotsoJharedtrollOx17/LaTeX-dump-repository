...
\newpage
\section*{Diagrama de la actividad}
\begin{figure}[H]
    \caption{\emph{Diagrama de transición de estados del escrito adjunto\\}}
    \centering
    \smallskip
    \includegraphics[scale=0.8]{diagrama1.png}
    \bigskip
